...
CREATE TABLE `dated` (
  ...
  KEY `wtcount` (`wtcount`),
  KEY `qcount` (`qcount`)
) ENGINE=InnoDB AUTO_INCREMENT=7343863 DEFAULT CHARSET=utf8;
...
CREATE TABLE `hosts` (
  ...
  KEY `usg` (`usg`)
) ENGINE=InnoDB AUTO_INCREMENT=669187 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `times` (
  ...
  KEY `qdatetime` (`qdatetime`),
  KEY `ipaddr` (`ipaddr`)
) ENGINE=InnoDB AUTO_INCREMENT=436336 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-10-24  8:53:02
