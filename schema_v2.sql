...
CREATE TABLE `dated` (
  ...
  KEY `wtcount` (`wtcount`),
  KEY `qcount` (`qcount`)
) ENGINE=InnoDB AUTO_INCREMENT=7403124 DEFAULT CHARSET=utf8;
...
CREATE TABLE `hosts` (
  ...
  KEY `usg` (`usg`)
) ENGINE=InnoDB AUTO_INCREMENT=675766 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `times` (
  ...
  KEY `qdatetime` (`qdatetime`),
  KEY `ipaddr` (`ipaddr`)
) ENGINE=InnoDB AUTO_INCREMENT=439862 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-10-24  9:31:06
